...
6. **Taxonomy seed of 30 biomarkers is small.** Many edge-case biomarkers will trigger pending queue. Acceptable for capstone (small corpus); v1 needs broader seed (~100 biomarkers).
